...
L.Control.GeoSearch = L.Control.extend({
    ...
    setConfig: function (options) {
        this._config = {
            ...
            'searchLabel': options.searchLabel || 'Поиск адреса...',
            'notFoundMessage' : options.notFoundMessage || 'Адрес не найден, проверьте раскладку, записывайте "Страна, город, улица"',
